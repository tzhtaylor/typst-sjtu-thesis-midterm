...
#let mid-exam-date = datetime(year: 2024, month: 12, day: 30)
...
#let info = (
  ...
  school: "上海交通大学",
  major: "电子信息",
  date: mid-exam-date.display("[year]年[month]月[day]日"),
)
...
#set page(numbering: numbly("{1}", "{1} / {2}"))
...
#align(
  ...
  table(
    ...
    [论文开题日期 #linebreak() Thesis Proposal Date], [#proposal-date.display("[year]年[month]月[day]日")],
  ),
)

#set text(font: ziti.kaiti, size: zihao.xiaosi)
#show heading: set par(leading: 1em)
#set par(leading: 1em, first-line-indent: 3.5em, spacing: 1.25em, hanging-indent: 1.5em)
...
#kouhu(builtin-text: "zhufu", length: 400)
